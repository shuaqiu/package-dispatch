...
<div id="menuBar" data-dojo-type="dijit.MenuBar">
  ...
  <div data-dojo-type="dijit.PopupMenuBarItem">
    ...
    <div data-dojo-type="dijit.DropDownMenu">
      ...
      <div data-dojo-type="dijit.MenuItem" data-dojo-props="onClick: function(){showTab(['qiuq/system/user'], {title: '用户管理', href: 'web/user/list'}, this.id);}">用户管理</div>
      <div data-dojo-type="dijit.MenuItem" data-dojo-props="onClick: function(){showTab(['qiuq/system/role'], {title: '角色管理', href: 'web/role/list'}, this.id);}">角色管理</div>
